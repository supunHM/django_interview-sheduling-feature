...
class Company(models.Model):
    ...
    cmp_username = models.CharField(max_length=20)
...
class Cv(models.Model):
    instiute = models.CharField(max_length=20)
    ...
    optional_detail = models.IntegerField(blank=True, null=True)
    stu_nic = models.ForeignKey('Student', models.DO_NOTHING, db_column='stu_nic')
